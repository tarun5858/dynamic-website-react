const BlogData = [
  {
    ...
    points: ["HOME LOANS"],
    heading:
      "Beyond the Basics: Unlocking Hidden Benefits of Home Loans in India",
    // "Home Loans",
    subheading:
    ...
    subttileHead2: [
      ...
      {
        section: "Joint Home Loan Benefits",
        benefits: ["ABoth co-borrowers can claim tax deductions individually"],
      },
    ],
    ...
    subttileHead3: [
      ...
      {
        name: "Opt for Shorter Loan Tenure",
        benefits: ["Higher EMI but significantly lower total interest"],
      },
      {
        name: "Prepay When Possible",
        benefits: [
      ...
      },
      {
        ...
        benefits: ["Switch to a lower interest rate after a few years"],
      },
    ],
    ...
    subttileHead4: [
      ...
      },
      {
        ...
        benefits: ["Use home equity for other investments or emergencies"],
      },
    ],
    ...
    subttileHead5: [
      ...
      },
      {
        ...
        benefits: ["Live in the home before committing to purchase"],
      },
      {
        name: "Potential for Price Lock",
        benefits: [
          "Agree on future purchase price, potentially benefiting from appreciation",
        ],
      },
      {
        name: "Credit-Building Opportunity",
        benefits: ["Consistent rental payments may help improve credit score"],
      },
    ],
    conclusion1: `As we wrap up our exploration of home loans, it's important to remember that securing financing is just one step in the homebuying process. Another crucial aspect is choosing the right property that fits both your needs and budget.`,
    conclusion2: `In our next series, we'll dive into "Choosing Between Under Construction and Ready-to-Move-In Properties." This guide will help you navigate the pros and cons of each option, considering factors like timelines, costs, and potential risks. Whether you're leaning towards a brand-new development or a move-in ready home, understanding these differences is key to making the best choice for your situation.`,
    nextSeries:
  ...
  },
  {
    ...
    "subttileHead": [
      ...
      {
        name: "Address Proof",
        benefits: ["Utility bills, Rental agreement, etc."],
      },
      {
        name: "Income Proof",
  ...
  },
  {
    ...
    blogTags: ["Home Loans"],
    points: ["DOWN PAYMENT"],
    heading: "The Power of Credit Scores in Home Loans",
    subheading:
    ...
    subttileHead2: [
      ...
      {
        name: "Keep Credit Utilization Low",
        benefits: ["Aim to use less than 30% of available credit"],
      },
      {
        name: "Maintain a Mix of Credit Types",
        benefits: [
      ...
      },
      {
        ...
        benefits: ["Too many inquiries can lower your score"],
      },
      {
        name: "Regularly Check Your Credit Report",
    ...
    subttileHead3: [
      ...
      {
        name: "Opportunity to Improve",
        benefits: [
          "Time to build credit before applying for a traditional mortgage",
        ],
      },
      {
        name: "Lower Initial Requirements",
        benefits: ["Easier entry for those with lower credit scores"],
      },
    ],
    conclusion1: `Your credit score is a powerful tool in your homeownership journey. Whether you're aiming for a traditional home loan or considering alternative paths like rent-to-own, a good credit score opens doors to better financial opportunities.`,
  },
  {
    id: 4,
    ...
    subttileHead: [
      {
        ...
        benefits: [
          ...
          "Pros: Predictable EMIs, protection against interest rate hikes",
          "Cons: Higher initial interest rates, miss out on benefits if market rates drop",
        ],
      },
      {
        name: "Floating Rate Home Loans",
        benefits: [
          "Interest rate fluctuates with market conditions",
          "Pros: Generally lower initial rates, benefit from market rate drops",
          "Cons: Unpredictable EMIs, risk of higher payments if rates rise",
        ],
      },
      {
        name: "Hybrid Home Loans",
        benefits: [
          "Combination of fixed and floating rates",
          "Fixed for an initial period, then switches to floating",
        ],
      },
    ],
    ...
    subttileHead1: [
      ...
      },
      {
        name: "Tenure",
        benefits: [
          "The duration of your loan repayment period",
      ...
      },
      {
        ...
        benefits: [
          ...
          "Can be fixed, floating, or hybrid",
        ],
      },
      {
        name: "LTV (Loan-to-Value) Ratio",
        benefits: [
          "The percentage of the property value that can be financed",
          "Typically ranges from 75% to 90% for first-time buyers",
        ],
      },
    ],
    ...
    subttileHead2: [
      ...
      },
      {
        name: "Credit Score",
        benefits: [
          "Usually 750+ for the best rates and terms",
          "We'll dive deeper into this in our next blog!",
        ],
      },
      {
        name: "Property Evaluation",
        benefits: ["The chosen property must meet lender's criteria"],
      },
      {
        name: "Employment Status",
        benefits: [
          "Salaried individuals or self-employed professionals",
          "Minimum work experience often required",
        ],
      },
    ],
