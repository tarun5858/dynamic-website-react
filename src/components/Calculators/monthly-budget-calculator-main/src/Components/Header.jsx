              ...
              <div className="menu-wrap">
                <div className="main-menu">
                  <ul>
                    ...
                    <li><a href="https://prehome.in/success-stories">Success Stories</a></li>
                    <li className="mobile-dropdown dropdown">
                      ...
                      <ul className="dropdown-menu">
                        ...
                        <li><a href="https://prehome.in/calculators">Calculators</a></li>
                      </ul>
                    </li>
                    <li className="mobile-dropdown dropdown">
                      <a href="javascript:void(0);" className="dropdown-toggle">Company <FaChevronDown /> </a>
                      <ul className="dropdown-menu">
...
>
  ×
    ...
    <a href="https://www.prehome.in" className="text-white d-block py-2">
      Home
    </a>
  </li>
      <li style={{marginBottom: "15px"}}>
       ...
       <li style={{marginBottom: "15px"}}>
          <a
            href="https://prehome.in/success-stories.html"
    ...
    >
      <FaChevronDown />
            ...
            <li style={{marginBottom: "10px"}}>
                <a href="https://www.prehome.in/blog" className="text-white d-block py-1">
                  Blog
                </a>
              </li>
              <li style={{marginBottom: "10px"}}>
                <a href="https://www.prehome.in/contactus" className="text-white d-block py-1">
                  FAQs
                </a>
              </li>
             <li style={{marginBottom: "10px"}}>
                <a href="https://prehome.in/calculators.html" className="text-white d-block py-1">
                  Calculators
                </a>
              </li>
            </ul>
  ...
  >
    ...
    >
      <FaChevronDown />
            ...
            >
             <li style={{marginBottom: "10px"}}>
                <a href="https://www.prehome.in/ourstory" className="text-white d-block py-1">
                  Our Story
                </a>
              </li>
             <li style={{marginBottom: "10px"}}>
              ...
              <li style={{marginBottom: "10px"}}>
                <a href="https://www.prehome.in/termsandconditions" className="text-white d-block py-1">
                  Terms & Conditions
                </a>
              </li>
              <li style={{marginBottom: "10px"}}>
                <a href="https://www.prehome.in/privacypolicy" className="text-white d-block py-1">
                  Privacy Policy
                </a>
              </li>
            </ul>
