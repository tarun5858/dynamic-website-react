    ...
    >
      <FaChevronDown />
            ...
            <li style={{marginBottom: "10px"}}>
                <a href="https://www.prehome.in/blogs" className="text-white d-block py-1">
                  Blogs
                </a>
              </li>
              <li style={{marginBottom: "10px"}}>
             ...
             <li style={{marginBottom: "10px"}}>
                <a href="https://prehome-latest-build.vercel.app/calculators.html" className="text-white d-block py-1">
                  Calculators
                </a>
              </li>
            </ul>
