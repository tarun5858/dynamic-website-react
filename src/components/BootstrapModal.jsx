              ...
              <div className="popuprow">
                ...
                >
                      ...
                      >
                        <div className="col-12">
                          <button
                            ...
                            onClick={() =>
                              handleLocationSelection("Golf Course Road")
                            }
                            style={{
                              padding: "10px 20px",
                              border:
                                selectedLocation === "Golf Course Road"
                                  ? "2px solid #007bff"
                                  : "1px solid #ccc",
                              backgroundColor:
                                selectedLocation === "Golf Course Road"
                          ...
                          <button
                            ...
                            style={{
                              padding: "10px 20px",
                              border:
                                selectedLocation === "Southern Peripheral Road"
                                  ? "2px solid #007bff"
                                  : "1px solid #ccc",
                              backgroundColor:
                                selectedLocation === "Southern Peripheral Road"
                          ...
                          <button
                            ...
                            style={{
                              padding: "10px 20px",
                              border:
                                selectedLocation === "Dwarka Expressway"
                                  ? "2px solid #007bff"
                                  : "1px solid #ccc",
                              backgroundColor:
                                selectedLocation === "Dwarka Expressway"
                          ...
                          <button
                            ...
                            onClick={() =>
                              handleLocationSelection("Sohna Road")
                            }
                            style={{
                              padding: "10px 20px",
                              border:
                                selectedLocation === "Sohna Road"
                                  ? "2px solid #007bff"
                                  : "1px solid #ccc",
                              backgroundColor:
                                selectedLocation === "Sohna Road"
                            ...
                            style={{
                              ...
                              backgroundColor:
                                selectedLocation === "Other"
                                  ...
                                  : "#f3f3f3",
                              color:
                                selectedLocation === "Other" ? "#fff" : "#333",
                              transition: "all 0.3s",
                              margin: "5px",
                              cursor: "pointer",
                              borderRadius: "25px",
                  ...
                  <div className="col-md-12">
                    ...
                    >
                      We’re here to help you find the right home—your info stays
                      safe with us.
                    </p>
                    {errors.layout && (
                      <span style={{ color: "red", fontSize: "12px" }}>
                ...
                >
                  ...
                  >
                    Your details are private—we’ll only reach out with updates
                    that matter.
                  </p>
                </div>
              </div>
