...
//   (blog) =>
//     blog.topic &&
//     blog.topic.toLowerCase() === activeTopic.toLowerCase()
// )
//       : blogs;
...
//     ? blogs.filter((blog) => {
//         const matchesTopic =
//           blog.topic?.trim().toLowerCase() === activeTopic.toLowerCase();
...
//         } else if (Array.isArray(blog.blogTags)) {
//           tags = blog.blogTags.map((x) => x.trim().toLowerCase());
//         }

//         const matchesTags = tags.includes(activeTopic.toLowerCase());
